  ...
  const teamMembers = [
    {
      name: "Alex Rodriguez",
      role: "Founder & CEO",
      bio: "Former hedge fund manager with 15 years of experience in financial markets."
    },
    {
      name: "Samantha Chen",
      role: "Head of Product",
      bio: "Ex-Google product leader specialized in gaming and financial tech products."
    },
    {
      name: "Marcus Johnson",
      role: "Lead Developer",
      bio: "Full-stack engineer with expertise in real-time data processing systems."
    },
    {
      name: "Priya Sharma",
      role: "Financial Analyst",
      bio: "CFA with experience at top investment banks analyzing market trends."
    }
  ];
